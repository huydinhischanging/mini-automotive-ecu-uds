...
R6 & ISO-TP complete and tested; UDS server not implemented & open \\
...
\begin{itemize}
  ...
  \item UDS and DTC management are designed but not implemented; the Control ECU only counts diagnostic requests.
