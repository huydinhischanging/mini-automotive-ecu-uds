...
R6 & UDS over ISO-TP on 0x7E0/0x7E8 with NRCs: 22 unit tests, 14/14 on-target self-test, 22/22 steps from an external tester on the bus including hard reset & met \\
...
\begin{itemize}
  ...
  \item The external tester is a firmware tester on the Sensor ECU; a PC or Linux tester (SocketCAN, e.g. python-udsoncan) has not been used yet. The hard reset restarts the firmware, not the core.
